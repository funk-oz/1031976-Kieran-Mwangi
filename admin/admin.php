...
<body>
    ...
    <main class="main-content">
        ...
        <div class="container">
            ...
            <?php
            // Process updates only; do not trigger permission redirects on page load for non-super admins
            edit_admin($_SESSION['admin_id']);
            if (isset($_GET['edit']) && function_exists('current_user_is_super_admin') && current_user_is_super_admin()) {
            ...
            add_admin();
            if (isset($_GET['add']) && function_exists('current_user_is_super_admin') && current_user_is_super_admin()) {
            ?>
                <h2>Add New Admin</h2>
                <form action="admin.php" method="POST">
                    <div class="form-group">
                ...
                <table class="custom-table">
                    <thead>
                        <tr>
                            ...
                            <th>Email</th>
                            <th>
                                <?php if (function_exists('current_user_is_super_admin') && current_user_is_super_admin()) { ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php
                                // Show delete only to super admin and never for super admin accounts
                                if (function_exists('current_user_is_super_admin') && current_user_is_super_admin()) {
                                    // Prevent delete of super-admin rows by checking email against allow-list
                                    $isTargetSuper = is_super_admin_email($data[$i]['admin_email']);
                                    if (!$isTargetSuper && $data[$i]['admin_id'] != $_SESSION['admin_id']) {
                                ?>
                                    <td>
