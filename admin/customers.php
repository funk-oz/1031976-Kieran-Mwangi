            ...
            ?>
                ...
                <form action="customers.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input pattern="[A-Za-z_]{1,15}" type="text" name="fname" value="<?php echo htmlspecialchars($data[0]['user_fname']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input pattern="[A-Za-z_]{1,15}" type="text" name="lname" value="<?php echo htmlspecialchars($data[0]['user_lname']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?php echo htmlspecialchars($data[0]['email']); ?>">
                        <div class="form-text">Please enter the email in format: example@gmail.com.</div>
                    </div>
                    <br>
                    <div class="form-group">
                        <label>Phone Number</label>
                        <input type="tel" pattern="[0-9+\-\s()]{10,15}" name="phone" value="<?php echo (!empty($data[0]['user_phone'])) ? htmlspecialchars($data[0]['user_phone']) : ''; ?>">
                        <div class="form-text">Please enter a valid phone number (10-15 digits).</div>
                    </div>
                    <br>
                    <div class="form-group">
                        <label>Gender</label>
                        <select name="gender">
                            ...
                            <option value="Male" <?php echo (isset($data[0]['user_gender']) && $data[0]['user_gender'] == 'Male') ? 'selected' : ''; ?>>Male</option>
                            <option value="Female" <?php echo (isset($data[0]['user_gender']) && $data[0]['user_gender'] == 'Female') ? 'selected' : ''; ?>>Female</option>
                            <option value="Other" <?php echo (isset($data[0]['user_gender']) && $data[0]['user_gender'] == 'Other') ? 'selected' : ''; ?>>Other</option>
                        </select>
                        <div class="form-text">Please select the gender.</div>
                    </div>
                    <br>
                    <div class="form-group">
                        <label>Address</label>
                        <input pattern="^[#.0-9a-zA-Z\s,-]+$" type="text" name="address" value="<?php echo htmlspecialchars($data[0]['user_address']); ?>">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo (!empty($data[$i]['user_phone'])) ? htmlspecialchars($data[$i]['user_phone']) : 'N/A'; ?></td>
                                <td><?php echo (!empty($data[$i]['user_gender'])) ? htmlspecialchars($data[$i]['user_gender']) : 'N/A'; ?></td>
