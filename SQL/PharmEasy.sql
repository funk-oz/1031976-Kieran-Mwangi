...
(4, 'admin@gmail.com', 'Joe', 'Wan', 'admin');
...
INSERT INTO `categories` (`category_id`, `category_name`, `category_description`, `category_image`, `category_status`) VALUES
(1, 'Medical Machines', 'Blood pressure monitors, glucometers, nebulizers and other medical devices', 'medical-machines.jpg', 1),
(2, 'Medicines', 'Tablets, syrups, powders and other pharmaceutical products', 'medicines.jpg', 1),
(3, 'Self Care', 'Personal care items, soaps, shampoos and hygiene products', 'self-care.jpg', 1);
...
INSERT INTO `item` (`item_id`, `category_id`, `item_title`, `item_brand`, `item_details`, `item_tags`, `item_image`, `item_quantity`, `item_price`) VALUES
...
(28, 3, 'Seni Air Classic Breathable Adult Diapers Medium', 'Seni Air', 'Seni is the European brand of absorbent products and skin care solutions that won the trust of millions of incontinent patients as well as caregivers worldwide. Profound knowledge and a wealth of experience ensures maximum comfort of use and a specialist protection against skin disorders such as bedsores.', 'Seni Air Classic Breathable Adult Diapers Medium', 'Seni Air Classic Breathable Adult Diapers Medium.jpeg', 49, 550),
(29, 3, 'Cipla Saslic DS Foaming Face Wash, 60 ml', 'Cipla', 'Saslic DS Face Wash is a foaming face wash that contains the goodness of salicylic acid, encourages skin- cell replacement cycle', 'Cipla Saslic DS Foaming Face Wash, 60 ml', 'Cipla Saslic DS Foaming Face Wash, 60 ml.jpg', 50, 435),
(30, 3, 'Cetaphil Gentle Skin Cleanser, 250 ml', 'Cetaphil', 'Cetaphil Gentle Skin Cleanser is a mild, soap-free formulation that cleanses without irritation; leaves your skin soft and smooth', 'Cetaphil Gentle Skin Cleanser, 250 ml', 'Cetaphil Gentle Skin Cleanser, 250 ml.jpeg', 50, 563),
...
(37, 3, 'Kamasutra Urge Men Deodorant Spray, 150 ml', 'Kamasutra', 'Kamasutra Deodorant comes with an irresistible formula making you stand out in the crowd', 'Kamasutra Urge Men Deodorant Spray, 150 ml', 'Kamasutra Urge Men Deodorant Spray, 150 ml.jpeg', 49, 105),
(38, 2, 'Himalaya Geriforte Syrup 200 ml', 'Himalaya', 'The natural ingredients in Geriforte work synergistically to prevent free radical-induced oxidative damage to various organs.', 'Himalaya Geriforte Syrup 200 ml', 'Himalaya Geriforte Syrup 200 ml.jpeg', 50, 125),
(43, 2, 'Eno Regular Flavoured Powder, 5 gm', 'Eno', 'Eno helps in neutralizing the acid in your stomach. It gets to work in 6 seconds.', 'Eno Regular Flavoured Powder, 5 gm', 'Eno Regular Flavoured Powder, 5 gm.jpeg', 50, 19),
(44, 2, 'Benadryl Cough Formula Syrup 150 ml', 'Benadryl', 'Benadryl Syrup is used in the treatment of cough, and also, relieves allergy symptoms such as runny nose, stuffy nose, sneezing, watery eyes and congestion or stuffiness', 'Benadryl Cough Formula Syrup 150 ml', 'Benadryl Cough Formula Syrup 150 ml.jpeg', 50, 115),
(45, 2, 'Zinda Tilismath Unani Medicine, 5 ml', 'Zinda', 'Zinda Tilismath is a 100% herbal medicine, used to treat many common ailments like cold, cough, and more .', 'Zinda Tilismath Unani Medicine, 5 ml', 'Zinda Tilismath Unani Medicine, 5 ml.jpeg', 50, 119),
...
(48, 2, 'Himalaya Punarnava, 60 Capsules', 'Himalaya', 'It is an ayurvedic medicine, containing punarnava as an active ingredient that helps to support the urinary system, protect the kidney, soothe and calm the urinary tract.', 'Himalaya Punarnava, 60 Capsules', 'Himalaya Punarnava, 60 Capsules.jpeg', 50, 152),
...
INSERT INTO `user` (`user_Lname`, `email`, `user_password`, `user_id`, `user_fname`, `user_address`, `user_phone`, `user_gender`) VALUES
('user', 'user@gmail.com', 'user', 55, 'user', 'NO.18, VINAYAKANAGAR, J.P NAGAR, 5TH PHASE BANGALURU, KARNATAKA, INDIA - 560078', NULL, NULL),
('Banik', 'kalinda@gmail.com', '5Kalinda', 62, 'Kalinda', '4, Charmuni Compd, 400064', NULL, NULL),
('Unknown', 'user85@gmail.com', 'password', 85, 'User85', 'Address not provided', NULL, NULL);
